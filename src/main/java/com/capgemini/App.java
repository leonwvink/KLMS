...
public class App {
    ...
    public static void makeMenuData() {
        ...
        Dish salade = new Dish(4, "salade", EFoodType.Starter, 5, true, ingredientSalade);
        Dish soep = new Dish(5, "soep", EFoodType.Starter, 5, true, ingredientSoep);
        Dish lasagne = new Dish(6, "lasagne", EFoodType.Main, 3, true, ingredientLasagne);
        Dish pasta = new Dish(7, "pasta",EFoodType.Main, 8, false, ingredientPasta);
        ...
        Dish taart = new Dish(10, "taart", EFoodType.Dessert, 1, true, ingredientTaart);
        ...
        compoundMenu1.compoundMenuAdvisePrice();
        compoundMenu2.compoundMenuAdvisePrice();
        compoundMenu3.compoundMenuAdvisePrice();
        taart.dishCostPrice();
        salmonDish.dishCostPrice();
        salade.dishCostPrice();
        soep.dishCostPrice();
        lasagne.dishCostPrice();
        pasta.dishCostPrice();
        spagetti.dishCostPrice();
        ijs.dishCostPrice();
        ...
        menuCard.addMenuItemToMenuCard(compoundMenu2);
